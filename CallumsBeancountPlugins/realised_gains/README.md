...
`realised_gains` is a Fava extension that summarizes gain-related postings by year and person.
...
3. `realised_gains` summarizes gains-related amounts.
...
```beancount
CallumsBeancountPlugins.realised_gains
```
...
4. whether capital-gain dividends and realised gains should really be reviewed
